...
export default function UploadImage() {
    ...
    async function submit(e: React.FormEvent) {
        ...
        setMsg(null)
        try {
            const res = await uploadImage("eventID-<TODO>", file)
    ...
    return (<div>
        ...
        <p style={{fontSize: 12, color: '#666'}}>Sends the image to <code>/api/uploadImage</code>, stores it in Blob
            Storage, and enqueues a thumbnail job.</p>
    </div>)
}